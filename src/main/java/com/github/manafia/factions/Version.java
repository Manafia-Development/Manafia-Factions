...
import com.github.manafia.factions.util.particle.BukkitParticleProvider;
import com.github.manafia.factions.util.particle.PacketParticleProvider;
...
public class Version {
    ...
    public static void initNonPacketParticles() {
        if (FactionsPlugin.instance.version > 8) {
            ...
            FactionsPlugin.instance.log("Minecraft com.github.manafia.factions.Version 1.9 or higher found, using non packet based particle API");
        }
    }
